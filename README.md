...
- **Level 2:** two pedestrians, one steady farside crossing + one sudden nearside run — tests divided attention and reaction time
...
Built by a 5-person team; hardware/VR integration, environment design, traffic AI, UI, and sound were handled by teammates (full breakdown and citations in the paper). Platform: Unity 6000.0.49f1, Meta Quest 3 via XR Plugin / XR Interaction Toolkit / Oculus XR, physical steering wheel and pedal input via Unity's Input System.

## License / Use

Course project — asset packs used under their respective store licenses (see paper Annexure A for full list and sources). Scripts shared here for portfolio purposes.# VR Active Safety Driving Simulator
